...
| [`gui_modules/components.py`](file:///c:/file-date-sorter/gui_modules/components.py) | Reusable UI components: `HeaderCard`, `MetricCard`, `ActionButton`, `StyledEntry`, `FolderPicker`, `StatusBadge`. |
