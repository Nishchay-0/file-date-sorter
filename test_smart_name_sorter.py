...
class TestSmartNameSorter(unittest.TestCase):
    ...
    def test_08_snapchat_export_media_grouping(self):
        ...
        snap_files = [
            ...
            "Snapchat-285174442.zip.nomedia",
            "Snapchat-496339385.zip.nomedia",
            "Snapchat-794656458.zip.nomedia",
            "Snapchat-1104223881.zip.nomedia",
            "Snapchat-1499352345.zip.nomedia",
            "Snapchat-1806077806.zip.nomedia",
            "Snapchat-1959683120.zip.nomedia",
            "Snapchat-1995814549.zip.nomedia",
